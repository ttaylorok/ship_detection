...
checkpoint = ModelCheckpoint(PATH + "checkpoints_v3.out", monitor='accuracy', 
                             verbose=1, save_best_only=True, mode='max')

csv_logger = CSVLogger(PATH + "log_v3.out", append=True, separator=';')
...
results3 = m.fit_generator(aug_gen(image_gen(df_sample)),
                          epochs = 5, 
                          steps_per_epoch = 10,
...
test_gen = image_gen(df_test[df_test['count'] == 2])
